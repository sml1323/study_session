---
# FIXTURE VARIANT (eval 22): Ch.4 reached phase-3-complete with B1
# over-confident calibration state. Per B1 split:
#   chapter_complete = learning_passed (SM-only gate)
#   calibration_health = over_confident (gap > 20, predicted > actual)
#   confirm_next_chapter = true (gap > 30 threshold)
# review-routing must surface the confirm_next_chapter prompt before
# any chapter-advance recommendation.
...
hint_levels: [0, 1, 1, 0, 1]
avg_hint_level: 0.6
avg_answer_length: 36
textbase_recall_coverage: 0.55
situation_model_transfer_score: 0.75
situation_model_transfer_questions_count: 2
learning_passed: true
chapter_complete: true
confidence_self_report: 92
score_prediction: 95
actual_score: 60
score_prediction_gap: 35
calibration_gap_abs: 35
calibration_health: over_confident
confirm_next_chapter: true
confidence_accuracy_gap: 17
phase_3_attempts: 1
session_health:
  hint_abuse: false
  illusion: true                    # post-B1 trigger: calibration_health == over_confident
  surface: false
  struggle_skip: false
  form_fatigue: false
  echo: false
review_queue:
  - { due: 2026-05-04, type: 1d }
related_chapters:
